...
export class AboutCreteComponent implements OnInit {
  items:About[]=[
    ...
    },
    {
      ...
      RoadEng: "The lower Monastery of Kato Preveli is 32 km South of Heraklion, while the Upper Monastery of Piso Preveli is 33 km South of Heraklion. Preveli Monasteries can be reached by bus, taxi or rental car.",
